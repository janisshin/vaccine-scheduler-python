...
class Patient:
    ...
    def show_appointments(self):
        ...
        show_appointments = "SELECT ApptID, Name, Time, cUsername FROM Appointments WHERE pUsername = (%s) ORDER BY ApptID"
        try:
            ...
            print("pymssql error occurred when running Patient.show_appointments")
            raise
        finally:
            cm.close_connection()
